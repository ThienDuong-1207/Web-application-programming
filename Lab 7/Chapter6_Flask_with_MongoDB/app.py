...
def exercise2():
    if request.method == "POST":
        ...
        return redirect(url_for("exercise2"))  # hoặc về trang khác nếu muốn
...
def exercise8():
    ...
    if selected_major:
        ...
        students = []
    # Lấy danh sách các ngành duy nhất để hiển thị trong dropdown
...
def exercise16():
    gender = request.args.get('gender')  # lấy giới tính từ form
    if gender:
